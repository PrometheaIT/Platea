...
// src/app/services/Base/geography.service.ts
var GeographyService = class _GeographyService {
  // Tutte le province italiane hardcoded
  provinces = [
    { "code": "", "name": "Tutte", "region": "Tutte" },
    ...
    { "code": "FC", "name": "Forl\xEC-Cesena", "region": "Emilia-Romagna" },
  ...
  getFilteredProvinces() {
    return of(this.provinces.filter((p) => p.code !== ""));
  }
  getProvinceName(code) {
    const province = this.provinces.find((p) => p.code === code);
    return province ? province.name : "";
  }
  static \u0275fac = function GeographyService_Factory(__ngFactoryType__) {
    return new (__ngFactoryType__ || _GeographyService)();
  };
  static \u0275prov = /* @__PURE__ */ \u0275\u0275defineInjectable({ token: _GeographyService, factory: _GeographyService.\u0275fac, providedIn: "root" });
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(GeographyService, [{
    type: Injectable,
    args: [{
      providedIn: "root"
    }]
...
//# sourceMappingURL=chunk-BF5ZNUI6.js.map
